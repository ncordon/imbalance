...
[![packageversion](https://img.shields.io/badge/Package%20version-0.1.0-orange.svg?style=flat-square)](https://github.com/ncordon/imbalance/commits/master)
...
```{r example-pdfos, fig.width = 10, fig.height = 10, fig.path = "./man"}
library("imbalance")
data(newthyroid1)
