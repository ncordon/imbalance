...
banana <- dfnormalize(RKEEL::read.keel("../Data/bananaRUS.dat"))
banana_orig <- dfnormalize(RKEEL::read.keel("../Data/banana_original.dat"))
...
levels(banana_orig$Class) <- c("negative", "positive")
levels(banana$Class) <- c("negative", "positive")
